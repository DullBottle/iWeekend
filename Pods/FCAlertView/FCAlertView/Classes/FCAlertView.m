...
- (void)drawRect:(CGRect)rect {
    ...
    separatorLineView.backgroundColor = [UIColor colorWithWhite:193.0f/255.0f alpha:1.0]; // set color as you want.
    if (_darkTheme)
    ...
    if (_numberOfButtons == 0) { // View only contains DONE/DISMISS Button
        ...
        horizontalSeparator.backgroundColor = [UIColor colorWithWhite:193.0f/255.0f alpha:1.0]; // set color as you want.
        if (_darkTheme)
        ...
        UIView *firstSeparator = [[UIView alloc] initWithFrame:CGRectMake(0,
                                                                          ...
                                                                          alertViewFrame.size.width,
                                                                          1.f)];
        firstSeparator.backgroundColor = [UIColor colorWithWhite:193.0f/255.0f alpha:1.0]; // set color as you want.
        if (_darkTheme)
        ...
        if (_hideDoneButton)
            secondSeparator.frame = CGRectMake(alertViewFrame.size.width/2 - 1,
                                               ...
                                               1.f,
                                               45);
        secondSeparator.backgroundColor = [UIColor colorWithWhite:193.0f/255.0f alpha:1.0]; // set color as you want.
        if (_darkTheme)

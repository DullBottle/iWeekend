...
@interface CombinationOutputView () <TabIndicatorViewDelegate, UIScrollViewDelegate>

@property (nonatomic, strong) UIScrollView *scrollView;

@end

@implementation CombinationOutputView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        [self.scrollView setContentSize:CGSizeMake((width - 40) * 2, 245)];
        self.scrollView.pagingEnabled = YES;
        self.scrollView.showsHorizontalScrollIndicator = NO;
        [self addSubview:self.scrollView];
        
        // FixedPaymentResultView.
        self.fixedPaymentResultView = [[CombinationFixedPaymentView alloc] initWithFrame:CGRectMake(0, 0, width - 40, 245)];
        [self.scrollView addSubview:self.fixedPaymentResultView];
        
        // fixedBasisResultView.
        self.fixedBasisResultView = [[CombinationFixedBasisView alloc] initWithFrame:CGRectMake(width - 40, 0, width - 40, 245)];

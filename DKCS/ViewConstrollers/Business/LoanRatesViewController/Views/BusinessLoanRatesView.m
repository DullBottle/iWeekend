...
@interface BusinessLoanRatesView () <UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation BusinessLoanRatesView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        // collectionView.
        CGFloat width = ([UIScreen mainScreen].bounds.size.width - 40) / 4.f;
        ...
        self.reminderLabelOne.text = @"1.最新利率更新时间为2015年10月24日。";
...
{
    return self.viewModel.businessRates.count;
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *text = [self.viewModel.businessRates objectAtIndex:indexPath.row];
